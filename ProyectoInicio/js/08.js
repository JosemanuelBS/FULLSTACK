...
function ProductoClase(nombre="tablet",precio,disponibilidad=false,categoria="play"){
...
// const producto3 = new ProductoClase(undefined,undefined,undefined);
...
producto3.formatearProducto();
producto4.formatearProducto();
...
class ProductoClase2{
    ...
    formatearProducto2(){
        console.log(`El producto ${this.nombreObjeto2} 
        tiene un precio de ${this.precioObjeto2} €`);
    }
}
...
!!!!!!!!!!!!!!!!!!!!
EJERCICIO
CREAR UN OBJECT CONSTRUCTOR Libro CON PROPIEDADES nombre, precio, 
isbn
HACIENDO USO DEL CONSTRUCTOR
Y GENERAR DOS INSTANCIA AL MENOS
*/
...
class Categoria extends Libro{
    ...
    formatearProducto3(){
        ...
        pertenece a la categoria ${this.categoria}`)
    }
}
