...
function sumar(josemanolo, pepito) {
    console.log(josemanolo + pepito)
};
...
CREAR UNA FUNCION RESTAR
4 ARGUMENTOS DE ENTRADA
RESTAR CON DECLARACION
RESTAR2 CON EXPRESION

LLAMAR 2 VECES CON CADA UNA

//ejerciciorestar*/

function eJrestar(n1, n2, n3, n4) {
    console.log(`resta n1:${n1} n2:${n2} n3:${n3} n4:${n4} 
    y el resultado es: ${n1 - n2 - n3 - n4}`)
}
eJrestar(1, 2, 3, 4);
eJrestar(10, 9, 8, 7);

let eJrestar2=function(n1, n2, n3, n4) {
    console.log(`resta n1:${n1} n2:${n2} n3:${n3} n4:${n4} 
    y el resultado es: ${n1 - n2 - n3 - n4}`)
}
eJrestar2(1, 2, 3, 4);
...
console.log(parseInt(numero2),typeof parseInt(numero2)); 
// parseInt() ES UNA FUNCION
console.log(numero1.toString(),typeof numero1.toString()); 
...
function blackFriday(importe,descuento){
    console.log(`El descuento total es de ${descuento*importe/100} €`);
    console.log(`El importe total a pagar es de ${importe-descuento*importe/100} €`);
};
...
function ecuacion(A=1,B=1,C=1){
    console.log("RESULTADO +RAIZ",(-B+Math.sqrt(B*B-4*A*C))/(2*A));
    console.log("RESULTADO -RAIZ",(-B-Math.sqrt(B*B-4*A*C))/(2*A));
};
