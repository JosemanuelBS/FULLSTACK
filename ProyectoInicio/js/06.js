...
REPASO DÍA ANTERIOR
    ...
    /*
        ...
        CUANDO SOLO SE TIENE UNA LINEA EN EL CUERPO DE LA FUNCIÓN 
        ...
        CUANDO SOLO SE TIENE UN PARÁMETRO SE PUEDE ELIMINAR LOS PARÉNTESIS
            SI HAY MAS DE UN PARAMETRO, VACIO, 
            O INICICIALIZADO HAY QUE PONERLO()
        EL RETURN VA IMPLICITO EN EL CUERPO DE LA FUNCIÓN, SE PUEDE OMITIR 
        SU VA SOLO
            SI HAY MÁS DE UNA LINEA EN EL CUERPO DE LA FUNCIÓN HAY QUE PONERLO

        let triplicarFlecha = (numero=1) => console.log("VALOR DE TRIPLICAR 
        CON ARROW FUNCTION",numero*numero*numero);
...
/*
EJERCICIO1.
CREAR UNA FUNCIÓN QUE SUME 3 NUMEROS DADOS. PONERLA CON EXPRESION, 
DECLARACIÓN Y COMO FUNCIÓN DE FLECHA
sumaExpresion
sumaDeclaracion
sumaFlecha
...
function sumarDeclaracion(n1, n2, n3) {
    console.log(n1 + n2 + n3);
}
sumarDeclaracion(2, 5, 6);

// EXPRESION DE LA FUNCION

let sumarExpresion = function (n1, n2, n3) {
    console.log(n1 + n2 + n3);
}
sumarExpresion(2, 5, 6)
...
/*
EJERCICI02
CREAR UNA FUNCIÓN QUE BUSQUE ELEMENTOS DE UN ARRAY
PONERLA COMO EXPRESION, DECLARACIÓN Y COMO FUNCIÓN DE FLECHA
buscaExpresion
buscaDeclaracion
buscaFlecha
*/
...
function buscarElementoD(array, elemento) {
    return array.includes(elemento);
}

let busqueda = "marrón"
let arrayBusqueda = ["rojo", "azul", "verde", "amarillo"]
let existeElementoD = buscarElementoD(arrayBusqueda, busqueda)

console.log(`Se encuentra ${busqueda} en el array?: ${existeElementoD}`);

//EXPRESION
const buscarElementoE = function (array, elemento) {
    return array.includes(elemento);
}

let existeElementoE = buscarElementoE(arrayBusqueda, busqueda)
console.log(`Se encuentra ${busqueda} en el array?: ${existeElementoE}`);

//FUNCION DE FLECHA
const buscarElementoF = (array, elemento) => array.includes(elemento);

let existeElementoF = buscarElementoF(arrayBusqueda, busqueda)
console.log(`Se encuentra ${busqueda} en el array?: ${existeElementoF}`);


/*
EJERCICIO3

CREAR UNA FUNCIÓN QUE COMPRUEBE SI UN NUMERO ES MAYOR QUE OTRO
...
*/
function comparadorExpresion(n1, n2) {
    return n1 > n2;
}
console.log("El numero 5 es mayor que 4?", comparadorExpresion(5, 4));

const comparadorDeclaracion = function (n1, n2) {
    return n1 > n2;
}
console.log("El numero 3 es mayor que 5?", comparadorDeclaracion(3, 5));

const comparadorFlecha = (n1, n2) => n1 > n2;

console.log("El numero 4 es mayor que 6?", comparadorFlecha(4, 6));
/*
...
if (PIN === 1234) {
    ...
    if (saldo > retirada) {
        console.log("Dinero suficiente, SUERTE")
    } else if (saldo === retirada) {
        console.log("VAMOS JUSTITOS")
    } else {
        console.log("DEJA DE GASTAR")
    }
} else {
    console.log("MIERDA, ME QUEDÉ SIN DINERO");
}
...
UN NÚMERO AL MULTIPLICARLO POR SI MISMO ES IGUAL
A 100. ES IGUAL A 200, Y SI NO CUMPLE LAS
ANTERIORES
...
if(ej12*ej12===100){
    console.log("ES 100")
} else if(ej12*ej12===200){
    console.log("ES 200")
} else{
    console.log("No es 100 ni 200")
};
...
switch(ej12*ej12){
    ...
    case 200: console.log("ES 200");
    break;

    default: console.log("No es ni 100 ni 200");
    break;
}
...
//NUMEROS DEL 100 AL 200 DE 5 EN 5
