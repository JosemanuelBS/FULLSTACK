...
*/
    const producto = "Juego de mesa EL PUEBLO DUERME"; //LA MAS UTILIZADA
    ...
    // VAMOS AÑADIR EN EL CONSOLE.LOG
...
*/
    ...
    console.log("METODO LENGTH:",producto.length); 
    // ME DICE LA LONGITUD DE LA VARIABLE

    // INDEXOF PARA BUSCAR SI UNA PALABRA EXISTE EN 
    // UNA CADENA DE TEXTO Y ME DA LA POSICION
    ...
    console.log("METODO INCLUDES:",producto.includes("DUERME"));



let twitter= "Domingo en Santiago con ocas";
console.log("characters twitter", twitter.length);
...
INTRODUCCION A JAVASCRIPT
    ...
    ESTILOS PARA NOMBRAR A LAS VARIABLES - CAMEL CASE

    TIPOS DE DATOS EN JAVASCRIPT

        STRING
            VIMOS METODOS .LENGTH .INDEXOF .INCLUDES
...
console.log("TYPEOF NUMERO 1:", typeof numero1,numero1);
console.log("TYPEOF NUMERO 2:", typeof numero2,numero2);
console.log("TYPEOF NUMERO 3:", typeof numero3,numero3);
console.log("TYPEOF NUMERO 4:", typeof numero4,numero4);
...
EJERCICIO
QUE RESULTADO TENDRÁ ETSTA OPERACIÓN
...
let ahorroTotal = ((prenda1 + prenda2 + prenda3)*descuento)/100;
let precioFinal = (prenda1 + prenda2 + prenda3) - ahorroTotal; 
...
console.log("ANTES DEL INCREMENTO",++meGusta)
console.log("TRAS EL DECREMENTO",meGusta--)
console.log("ANTES DEL DECREMENTO",--meGusta)
...
const nombreJM = "Jose Manuel";
const emailJM = "jose@jose.es";

console.log("concatenacion nombre + email","Nombre: "+nombreJM+" Correo: "+emailJM)
...
console.log(`Uso TEMPLATE STRING Nombre de usuario ${nombreJM} y su email es ${emailJM}`);
