...
const usuarioAutenticado = new Promise((resolve,reject)=>{ 
    ...
    if(auth){
        ...
        // EL PROMISE SE CUMPLE
    }else{
        reject("No se puedo iniciar sesion"); 
        // EL PROMISE NO SE CUMPLE
    }
});
        ...
        */
        usuarioAutenticado
            .then(function(resultado){ 
                // SE EJECUTA CUANDO EL PROMISE SE CUMPLE
                console.log(resultado)
            })
            .catch(function(resultado){ 
                // SE EJECUTA CUANDO EL PROMISE NO SE CUMPLE
                console.log(resultado)
            })
...
//UNA RESPUESTA
console.log("ESPERANDO AL SETTIMEOUT")
...
function descargarNuevosClientes(){ 
    // VAMOS A CONTEMPLAR UNICAMENTE EL CASO DE EXITO, 
    // PARA FACILITAR EL EJEMPLO
    return new Promise(resolve =>{
        console.log("Descargando clientes... espere...")
        setTimeout(()=>{ 
            //PARA SIMULAR LA DESCARGA DE LA BASE DE DATOS
...
//!!!!!!!!!!!!!!!!!!!!!!
//EJERCICIO
//CREAR UNA FUNCION QUE ME DESCARGUE LOS PEDIDOS, Y ME DE 
//UNA RESPUESTA A LOS 3 SEGUNDOS
